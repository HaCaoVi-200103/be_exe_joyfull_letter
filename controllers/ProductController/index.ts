...
export const getProductID = async (req: Request, res: Response) => {
    try {
        ...
        const result = await Product.findOne({ _id: proId }).where({ is_delete: false })
...
export const createProduct = async (req: Request, res: Response) => {
    try {
        ...
        const result = await Product.create({ cate_id, pro_name, pro_price, pro_discount, pro_size, pro_picture, pro_description })
        console.log(result);
...
export const updateProductById = async (req: Request, res: Response) => {
    try {
        ...
        const result = await Product.findByIdAndUpdate(proId, { cate_id: cate_id, pro_name: pro_name, pro_price: pro_price, pro_discount: pro_discount, pro_size: pro_size, pro_picture: pro_picture, pro_description: pro_description, update_at: new Date(), is_delete: is_delete }, { new: true })
